...
time=np.loadtxt(r"D:\学习\barca\仪器分析实验\数据\动力学\20211122-F\X1.txt")
wavelength=np.arange(260,300,1)
...
X=np.loadtxt (r"D:\学习\barca\仪器分析实验\数据\动力学\20211122-F\Y1.txt")
X=X.T
...
plt.savefig(r'D:\学习\barca\仪器分析实验\数据\动力学\20211122-F\Y1的图SL.png')
plt.show()
