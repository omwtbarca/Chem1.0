...
plt.plot(x,Y_Modpoly_output,'y',label="贝壳")
...
xhat,yhat=smooth(x,y,7)
yhat=polyFit(xhat,yhat)
plt.plot(xhat,yhat,'b',label="苯甲酸")
...
baseObj = BaselineRemoval(y)
Y_Modpoly_output=baseObj.ModPoly()
plt.plot(x,Y_Modpoly_output,'g',label="玻璃")
...
xhat,yhat=smooth(x,y,7)
yhat=polyFit(xhat,yhat)
plt.plot(xhat,yhat,'c',label="硫酸钙")
...
xhat,yhat=smooth(x,y,7)
yhat=polyFit(xhat,yhat)
plt.plot(xhat,yhat,'m',label="四氯化碳")
...
xhat,yhat=smooth(x,y,7)
yhat=polyFit(xhat,yhat)
plt.plot(xhat,yhat,'k',label="二氯甲烷")
...
xhat,yhat=smooth(x,y,7)
yhat=polyFit(xhat,yhat)
plt.plot(xhat,yhat,'r',label="二甲基吡咯")
...
xhat,yhat=smooth(x,y,7)
yhat=polyFit(xhat,yhat)
plt.plot(xhat,yhat,'g',label="二氯乙烷")
